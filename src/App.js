...
import KlerosContract from "./Components/KlerosContract";
import FAQ from './Components/FAQ';
import Contact from './Components/Contact';
//import SeriesAA from "./components/SeriesAA";
//import SAFE from "./components/SAFE";
//import Unicontract from "./components/Unicontract";
import {
  Button,
  Container,
  Icon,
...
class App extends React.Component {
  ...
  componentDidMount() {
    document.title = "Kleros Contract"
  }
  handlePusher = () => {
  ...
  renderForm = () => {
    if (this.state.index == 0) return <KlerosContract />;
  ...
  render() {
    ...
    const leftItems = [
      {
        as: "a",
        content: "Kleros Escrow Contract",
        onClick: () => this.setState({ index: 0, visible: false }),
        key: "Kleros Escrow Contract"
      },
      {
        as: "a",
        content: "FAQ",
