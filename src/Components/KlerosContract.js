...
const openLawConfig = {
    ...
    templateName: "KLEROS ESCROW CONTRACT",
...
class KlerosContract extends React.Component {
    ...
    render() {
        ...
        return (
            <Container text style={{ marginTop: "2em" }}>
                <h1>KLEROS ESCROW CONTRACT</h1>
                <h2>This contract requires signers to have an email linked to their OpenLaw account</h2>
                <OpenLawForm
                    apiClient={apiClient}
                    executionResult={executionResult}
